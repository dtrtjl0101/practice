...
import qwerty.chaekit.domain.notification.NotificationRepository;
...
public class NotificationService {
    ...
    public PageResponse<NotificationResponse> getNotifications(UserToken userToken, Pageable pageable) {
        ...
        Page<Notification> notifications = notificationRepository.findByReceiverOrderByCreatedAtDesc(userProfile, pageable);
